...
class _LogInViewState extends ConsumerState<LogInView> {
  ...
  void initState() {
    ...
    emailCtlr.addListener(() {
      ...
      bool validStudentEmail = emailCtlr.text.isValidStudentEmailAddress;
          ...
          child: RelativeBuilder(builder: (context, height, width, sy, sx) {
            return Column(
              ...
              children: [
                ...
                Divider(color: McAppColors.appGreyShadeColor, height: sy(50)),
                Text(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffix: isEmailValid
                          ...
                          : const Icon(Icons.sentiment_dissatisfied,
                              color: McAppColors.appRedIndicatorColor),
                      filled: fillField,
                ...
                Theme(
                  data: Theme.of(context).copyWith(
                    colorScheme: ThemeData().colorScheme.copyWith(
                          primary: McAppColors.appGreyShadeColor,
                        ),
                  ),
                  child: TextField(
                    controller: pwdCtlr,
